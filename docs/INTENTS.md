...
| `show-notification`    | `notification:show`       | `show`                                                                                                                     | --                                                                            |
| `close-notification`   | `notification:close`      | `close`                                                                                                                    | --                                                                            |
| `resolve-workspace`    | `workspace:resolve`       | `resolve`                                                                                                                  | --                                                                            |
| `resolve-project`      | `project:resolve`         | `resolve`                                                                                                                  | --                                                                            |
| `open-workspace`       | `workspace:open`          | `create`, `provision`, `prepare`, `setup`, `finalize`                                                                      | `workspace:loading`, `workspace:created`, `workspace:create-failed`           |
...
index.ts (composition root)
    ...
    +-- Dispatch app:start intent
        ...
        AppStartOperation
              ...
              +-- "migrations" (settle on-disk data, e.g. a moved workspaces root)
