...
<!-- Poster frame generated by `pnpm demo:record`; the full demo video plays on the site. -->
<div align="center">
  <a href="https://codehydra.stho.net">
    <img src="site/public/screenshot.png" alt="CodeHydra showing multiple workspaces with AI agents running in parallel" width="800">
  </a>
  <p><a href="https://codehydra.stho.net"><strong>▶ Watch the demo</strong></a></p>
</div>
