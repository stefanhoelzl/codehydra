 ...
 * BadgeManager is an internal implementation detail of this module.
 */
...
export interface BadgeModuleDeps {
  readonly platformInfo: PlatformInfo;
  readonly appLayer: AppLayer;
 ...
 * Constructs and owns a BadgeManager internally.
 *
 * @param deps - Dependencies for constructing the BadgeManager
 * @returns IntentModule with event subscriptions and shutdown hook
 */
export function createBadgeModule(deps: BadgeModuleDeps): IntentModule {
