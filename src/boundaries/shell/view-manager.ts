/**
 * ViewManager — composition-root facade over the iframe backend.
 *
 * Construction is cheap (just captures deps). The backend is created in
 * `create()`, which is called from the `app-start/init` hook — after the
 * window exists. This class is a thin delegating wrapper; production code
 * always constructs `ViewManager`, never `IframeViewManager` directly.
 */
...
export class ViewManager implements IViewManager {
  ...
  create(): void {
    ...
    this.impl = new IframeViewManager({
